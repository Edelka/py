...
def create_modified_list():
    ...
    for k in keys_set:  # iterating in list of keys
        ...
        # print(k)
        # print(temp_list)
        if len([j for j in temp_list if
                j != -1]) == 1:  # check if element of temp_list != -1, as result we have len()=1
...
dict_list = create_list()
print(dict_list)

final_dict_list = create_modified_list()
